# Default values
nprocs=40
fname="upwind-drp_6_pml-on0_elastic"

# upwind-drp_6_pml-on_attenuation-c2
# upwind-drp_6_pml-off_attenuation-c2
# upwind-drp_6_pml-on_elastic
# upwind-drp_6_pml-off_elastic
