...
# Define variable
CASE_NAME="upwind-drp_3_pml-off_anelastic-c2_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind-drp_4_pml-off_anelastic-c2_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind-drp_5_pml-off_anelastic-c2_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind-drp_6_pml-off_anelastic-c2_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind-drp_7_pml-off_anelastic-c2_B_mq"
