# Default values
nprocs=40
fname="traditional_6_pml-on0_elastic"

# traditional_6_pml-on_attenuation-c2
# traditional_6_pml-off_attenuation-c2
# traditional_6_pml-on_elastic
# traditional_6_pml-off_elastic
