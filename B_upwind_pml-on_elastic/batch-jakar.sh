...
# Define variable
CASE_NAME="upwind_2_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_3_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_4_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_5_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_6_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_7_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_8_pml-on_elastic_B_mq"

# Run the application
mpirun -np 40 ../../build/./waveqlab3d ${CASE_NAME}.in > ${CASE_NAME}.out

# Define variable
CASE_NAME="upwind_9_pml-on_elastic_B_mq"
